...
<p class="authors">
        <a href="#" target="_blank" rel="noopener">Saurabh Pathak</a>
        <span class="sep">·</span>
        <a href="#" target="_blank" rel="noopener">Elahe Arani</a>
        <span class="sep">·</span>
        <a href="#" target="_blank" rel="noopener">Mykola Pechenizkiy</a>
        <span class="sep">·</span>
        <a href="#" target="_blank" rel="noopener">Bahram Zonooz</a>
</p>

<p class="affils">
    <span>Eindhoven University of Technology</span>
</p>
